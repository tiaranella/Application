  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-white">
      <div className="flex flex-col justify-center items-center p-8 sm:p-12 md:p-24">
        ...
        <div className="w-full max-w-md mb-8">
          <h1 className="text-5xl font-display font-bold text-gray-900 mb-2">Create Account</h1>
          <p className="text-gray-500">Join us and start managing your events today</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md space-y-5" autoComplete="off">
          <div className="flex flex-col relative">
            ...
            <input 
              ...
              className={`w-full pl-11 pr-4 py-3 rounded-lg border bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all ${errors.name ? 'border-red-500' : 'border-gray-300'}`} 
              {...register('name')} 
            />
            {errors.name && <span className="text-red-500 text-xs mt-1 ml-1 font-medium">{errors.name.message}</span>}
          </div>
